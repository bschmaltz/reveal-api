...
class User < ActiveRecord::Base
  ...
  has_attached_file :avatar, :styles => { :medium => "300x300>", :thumb => "100x100>" }, :default_url => "https://s3.amazonaws.com/reveal-api-assets/static_assets/default_avatars/:style/default.jpg"
